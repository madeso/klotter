...
// basically a tinted vignette with noise (needs tweaking)
// https://www.youtube.com/watch?v=7MklBPjPmMg
...
void main()
{
    ...
    vec3 damage = mix(color, tint, vignette * nfs);
    o_frag_color = vec4(mix(color, damage, u_factor), 1.0f);
}
