...
struct ShaderProgram
{
     ...
     * @note The shader must be bound before calling this method.
     */
	void set_vec2(const Uniform& uniform, const glm::vec2& v);
     ...
     * @note The shader must be bound before calling this method.
     */
	void set_vec3(const Uniform& uniform, const glm::vec3& v);
     ...
     * @note The shader must be bound before calling this method.
     */
	void set_vec4(const Uniform& uniform, const glm::vec4& v);
     ...
     * @note The shader must be bound before calling this method.
     */
	void set_mat(const Uniform& uniform, const glm::mat4& mat);
     ...
     * @note The shader must be bound before calling this method.
     */
	void set_mat(const Uniform& uniform, const glm::mat3& mat);
