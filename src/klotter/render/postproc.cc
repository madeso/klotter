...
static ImVec2 calculate_region(const ImVec2& mouse_pos, const ImVec2& pos, const ImVec2& my_tex, const ImVec2& widget_size, float region_sz)
{
...
static void imgui_image(const FrameBuffer& img)
{
